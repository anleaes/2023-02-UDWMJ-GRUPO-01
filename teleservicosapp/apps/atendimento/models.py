...
class Atendimento(models.Model):
    ...
    materiais_atendimento = models.ManyToManyField(Materiais, through='materiais atendimento', blank=True)
    #profissional
    #servico
...
class MateriaisAtendimento(models.Model):
    created_on = models.DateTimeField(auto_now_add=True)
    updated_on = models.DateTimeField(auto_now=True)
    ...
    atendimento = models.ForeignKey(Materiais, on_delete=models.CASCADE)
